...
import { Headset, Truck, BadgeCheck } from "lucide-react";

export function About() {
  return (
    <main className="min-h-screen w-full flex flex-col items-center justify-center bg-gradient-to-br from-blue-100 via-white to-blue-200 relative overflow-hidden py-20">
      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 py-12">
        ...
        <p className="text-xl md:text-2xl w-3xl text-center xxl text-gray-700 mb-10 font-medium animate-fade-in delay-200">
          Discover quality products at unbeatable prices with ShopTop. We make
          shopping easy, enjoyable, and accessible for all.
        </p>
        <Link
          to="/store"
      ...
      <div className="relative z-10 mt-20 flex flex-col md:flex-row justify-center gap-12 md:gap-16 animate-fade-in delay-400">
        <div className="flex flex-col items-center bg-white/70 rounded-2xl shadow-lg px-8 py-8">
          <Headset className="w-16 h-16 text-blue-500 mb-4" />
        ...
        <div className="flex flex-col items-center bg-white/70 rounded-2xl shadow-lg px-8 py-8">
          <BadgeCheck className="w-16 h-16 text-blue-500 mb-4" />
          <span className="text-lg font-semibold text-gray-700">
            Quality Products
          </span>
        </div>
